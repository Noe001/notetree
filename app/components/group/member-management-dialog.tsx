...
export function MemberManagementDialog({
  ...
  const handleInvite = async () => {
    ...
    try {
      ...
      setInviteEmail('');
      notify.success('招待しました', 'メンバーを招待しました');
    } catch (error) {
      console.error('Failed to invite member:', error);
      notify.error('招待に失敗しました', error instanceof Error ? error.message : 'メンバーの招待に失敗しました');
    } finally {
      setIsInviting(false);
    }
  };
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              ...
              <Select value={inviteRole} onValueChange={(value: string) => setInviteRole(value as "admin" | "member")}>
                      ...
                      <>
                        <Select 
                          ...
                          onValueChange={(value: string) => 
                            onUpdateMemberRole(member.id, value as 'admin' | 'member')
                          }
                        >
